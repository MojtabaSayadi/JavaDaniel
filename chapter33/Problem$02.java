 ...
 * 33.18b). See Section 3.8 for computing BMI. Name the client Exercise33_02Client
 * and the server Exercise33_02Server.
 *
 *
 * @Mojtaba Sayadi
 * */
...
{
    // see Problem$082Server.java and Problem$02Client.java
}
